...
gen_data = [...                                                                                                                                                                                                                                           
      1         0     80      10440           213.00       350            2.00          4             2           -5          150                4                50             75          NaN         NaN           NaN               0               NaN 
      ...
      4         0     60      11900           252.00      0.02            2.00          1             1           -6            0                0                80            120          NaN         NaN           NaN               0               NaN 
];                                                                                                                                                                                                                                                       
                                                                                                                                                                                                                                                         
DEMAND = [450;530;600;540;400;280;290;500];
K_RES_UP = 0.10;    % if not specified, reserve up   is calculated as RES_UP(HOUR) = K_RES_UP*DEMAND(HOUR)
K_RES_DN = 0.10;    % if not specified, reserve down is calculated as RES_DN(HOUR) = K_RES_DN*DEMAND(HOUR)
%}
...
%           [MW]   [MW]    [BTU/kWh]*       [£/h]*       [£]           [£/MBTU]*     [h]           [h]          [h]         [£]                [h]            [MW/h]         [MW/h]        [£]        [£/MWh]      [£/MWh^2]          [£]            [h]
gen_data = [...                                                                                                                                                                                                                                      
     1       0.0  100.0       NaN            NaN              2050         NaN	        5           4          -10           NaN                NaN             NaN           NaN           820         9.023       0.00113             0            NaN 
     2       0.0  400.0       NaN            NaN              1460         NaN	        3           2           10           NaN                NaN             NaN           NaN           400         7.654       0.00160             0            NaN 
     ...
     6       0.0  200.0       NaN            NaN              1360         NaN	        2           2           10           NaN                NaN             NaN           NaN           175         7.054       0.00515             0            NaN 
     7     250.0  750.0       NaN            NaN              2300         NaN	        3           4          -10           NaN                NaN             NaN           NaN           600         9.121       0.00131             0            NaN 
     8       0.0  375.0       NaN            NaN              1370         NaN	        1           3           10           NaN                NaN             NaN           NaN           400         7.762       0.00171             0            NaN 
     9     275.0  850.0       NaN            NaN              2200         NaN	        4           3          -10           NaN                NaN             NaN           NaN           725         8.162       0.00128             0            NaN 
     10      0.0  250.0       NaN            NaN              1180         NaN	        2           1           10           NaN                NaN             NaN           NaN           200         8.149       0.00452             0            NaN 
];
...
%           [MW]   [MW]    [BTU/kWh]        [£/h]        [£]           [£/MBTU]      [h]           [h]          [h]         [£]                [h]            [MW/h]         [MW/h]        [£]        [£/MWh]      [£/MWh^2]         [£]          [h]
gen_data = ...                                                                                                                                                                                                                                       
[     1     150    405         NaN             NaN        9000             NaN         8             8           +8          4500                 5              NaN            NaN         1000         16.19       0.00048            0           NaN 
      2     150    405         NaN             NaN       10000             NaN         8             8           +8          5000                 5              NaN            NaN          970         17.26       0.00031            0           NaN 
      ...
      5      25    112         NaN             NaN        1800             NaN         6             6           -6           900                 4              NaN            NaN          450         19.70       0.00398            0           NaN 
